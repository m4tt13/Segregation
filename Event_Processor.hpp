...
void __stdcall Event_Processor(void* Event)
{
	...
	if (Local_Player != nullptr)
	{
		...
		char* Name = Get_Name_Type((unsigned __int32)Engine_Module + 1674432)(Event);
		...
		if (Name[0] == 'p')
		{
			...
			Victim_Number = Identifier_To_Number_Type((unsigned __int32)Engine_Module + 618464)((void*)((unsigned __int32)Engine_Module + 4085288), Get_Integer_Type((unsigned __int32)Engine_Module + 1674416)(Event, (char*)"userid", nullptr));

			Killer_Number = Identifier_To_Number_Type((unsigned __int32)Engine_Module + 618464)((void*)((unsigned __int32)Engine_Module + 4085288), Get_Integer_Type((unsigned __int32)Engine_Module + 1674416)(Event, (char*)"attacker", nullptr));
		}
		else
		{
			Victim_Number = Get_Integer_Type((unsigned __int32)Engine_Module + 1674416)(Event, (char*)"entindex_killed", nullptr);

			Killer_Number = Get_Integer_Type((unsigned __int32)Engine_Module + 1674416)(Event, (char*)"entindex_attacker", nullptr);
		}
