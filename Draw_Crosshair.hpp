void __thiscall Redirected_Draw_Crosshair(void* Unknown_Parameter)
{
	...
	auto Uber_Alles = [&](unsigned __int8 Red, __int32 X, __int32 Y)
	{
		...
		void* Surface = *(void**)((unsigned __int32)Client_Module + 8699336);
	...
	Get_Screen_Size_Type((unsigned __int32)Client_Module + 2853376)(&Screen_Width, &Screen_Height);
	...
	Rotation_Angle = __builtin_remainderf(Rotation_Angle - (*(Global_Variables_Structure**)((unsigned __int32)Client_Module + 7253660))->Frame_Time * Interface_Uber_Alles_Speed.Integer, 180);
}