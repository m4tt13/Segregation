...
void Redirected_Move(float Unknown_Parameter, __int8 Final)
{
	...
	if (*(void**)((unsigned __int32)Client_Module + 7603940) != nullptr)
	{
		...
		Render_Start_Type((unsigned __int32)Client_Module + 1900096)();
	}
	...
	Update_Animations_Type((unsigned __int32)Client_Module + 1570160)();
