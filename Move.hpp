...
void Redirected_Move(float Unknown_Parameter, __int8 Final)
{
	...
	if (*(void**)((unsigned __int32)Client_Module + 7596836) != nullptr)
	{
		...
		Render_Start_Type((unsigned __int32)Client_Module + 1890432)();
	}
	...
	Update_Animations_Type((unsigned __int32)Client_Module + 1561984)();
